...
On 6502 first 256 bytes of memory (Zero Page) is special place to which CPU has much faster access. It's therefore beneficial to locate often used variables or pointers there, however the place is sparse and often used also by external libraries you may use in your software (like music player).
...
### 12 - Inline functions and to active"register" keyword optimizations - 29 ticks (6% speedup)
